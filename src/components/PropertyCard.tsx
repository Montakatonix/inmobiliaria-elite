...
export function PropertyCard({ title, location, price, bedrooms, bathrooms, area, type, image }: PropertyCardProps) {
    ...
    <div className="card-elite group overflow-hidden">
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <div className="absolute top-4 left-4">
          <span className="bg-brand-navy/90 text-white text-xs font-medium px-3 py-1.5 rounded-sm">
            {type}
          </span>
        </div>
      ...
      {/* Info */}
      <div className="p-5">
        <h3 className="font-display text-lg font-semibold text-brand-navy mb-1 group-hover:text-brand-gold transition-colors">
          {title}
        </h3>
